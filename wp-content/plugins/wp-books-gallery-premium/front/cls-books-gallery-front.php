...
class WBG_Front 
{
	use Wbg_Core, Wbg_Gallery_Settings_Content, Wbg_Search_Content_Settings, Wbg_Search_Styles_Settings, Wbg_Single_Content_Settings;
	...
	function wbg_load_shortcode() {
		...
		if ( wbg_fs()->is_plan__premium_only('pro') ) {
			add_shortcode( 'wp_books_gallery_view', array( $this, 'wbg_load_featured_view' ) );
		}
	}
