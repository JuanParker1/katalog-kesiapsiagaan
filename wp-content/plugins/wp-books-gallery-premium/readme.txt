...
= 3.3 =
* Display Books by Language with Shortcode - Basic
* Order By - Title, Date, Author etc. with Shortcode - Basic
* Show-Hide Buy Now Button Option Added - Basic
* Buy Now Button Text Changing Option Added - Basic
* Show-Hide Buy Now Button in Gallery Page
* Show-Hide Buy Now Button in Single Page
* ISBN-13 Option Added - Pro
* Item Weight Option Added - Pro
...
* Display Rating in Single Page
* Show-Hide Rating Option in Gallery Settings Page
* Reading age taxonomy added
* Show-Hide Reading Age Option Added
* Reading Age Label Option Added
* Show-Hide Grade level Option Added
* Grade level Label Option Added
* Admin Tab Styling Overlap Issue Fixed
* Admin Sidebar Link Updated
* Icon Added to Details Page Book Info

= 3.1 =
* Display Featured Books with Slide and Grid view - Pro
* Display Latest Books with Slide and Grid view - Pro
* Display Categorized Books with Slide and Grid view - Pro
* Show-Hide Book Format Option Added to Details page
* Show-Hide Book Series Option Added to Details page
* Minor bug fixing
* Code optimized
...
* Book Format Added
* Book Series Added
* Number Format Applied to Price ( like- 7.33)
* Minor fixing
* Max width applied to details page
* Notice error fixed in details page

= 2.8 =
* Search Panel Item Drag & Drop Sorting - Pro
* Book Cost type option added to book insert page - Basic
* Regular price and Sale price option added - Basic
* 115 currency option added to Gallery settings - Basic
* Display price at gallery page
* Buy link option added - Basic
* Show-hide seacrh panel (Shortcode) - Basic
* Display all books of an author (Shortcode) - Basic
