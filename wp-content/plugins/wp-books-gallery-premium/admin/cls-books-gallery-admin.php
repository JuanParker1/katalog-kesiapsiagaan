...
class WBG_Admin 
{
	use Wbg_Core, Wbg_Core_Settings, Wbg_Gallery_Settings_Content, Wbg_Search_Content_Settings, Wbg_Search_Styles_Settings, Wbg_Single_Content_Settings;
	...
	function wbg_taxonomy_for_books() {
		...
		if ( wbg_fs()->is_plan__premium_only('basic') ) {
			// Book Format
			$bkFormat = array(
				'name' 				=> _x('Book Formates', WBG_TXT_DOMAIN),
				'singular_name' 	=> _x('Book Format', WBG_TXT_DOMAIN),
				'search_items' 		=> __('Search Book Formates', WBG_TXT_DOMAIN),
				'all_items' 		=> __('All Book Formates', WBG_TXT_DOMAIN),
				'parent_item' 		=> __('Parent Book Format', WBG_TXT_DOMAIN),
				'parent_item_colon'	=> __('Parent Book Format:', WBG_TXT_DOMAIN),
				'edit_item' 		=> __('Edit Book Format', WBG_TXT_DOMAIN),
				'update_item' 		=> __('Update Book Format', WBG_TXT_DOMAIN),
				'add_new_item' 		=> __('Add New Book Format', WBG_TXT_DOMAIN),
				'new_item_name' 	=> __('New Book Formate', WBG_TXT_DOMAIN),
				'menu_name' 		=> __('Book Formates', WBG_TXT_DOMAIN),
			);

			register_taxonomy('book_format', array('books'), array(
				'hierarchical' 		=> true,
				'labels' 			=> $bkFormat,
				'show_ui' 			=> true,
				'show_admin_column' => true,
				'query_var' 		=> true,
				'show_in_menu'		=> true,
				'rewrite' 			=> array('slug' => 'book-format'),
			));

			// Book Format
			$bkSeries = array(
				'name' 				=> _x('Book Series', WBG_TXT_DOMAIN),
				'singular_name' 	=> _x('Book Series', WBG_TXT_DOMAIN),
				'search_items' 		=> __('Search Book Series', WBG_TXT_DOMAIN),
				'all_items' 		=> __('All Book Series', WBG_TXT_DOMAIN),
				'parent_item' 		=> __('Parent Book Series', WBG_TXT_DOMAIN),
				'parent_item_colon'	=> __('Parent Book Series:', WBG_TXT_DOMAIN),
				'edit_item' 		=> __('Edit Book Series', WBG_TXT_DOMAIN),
				'update_item' 		=> __('Update Book Series', WBG_TXT_DOMAIN),
				'add_new_item' 		=> __('Add New Book Series', WBG_TXT_DOMAIN),
				'new_item_name' 	=> __('New Book Series', WBG_TXT_DOMAIN),
				'menu_name' 		=> __('Book Series', WBG_TXT_DOMAIN),
			);

			register_taxonomy('book_series', array('books'), array(
				'hierarchical' 		=> true,
				'labels' 			=> $bkSeries,
				'show_ui' 			=> true,
				'show_admin_column' => true,
		...
		if ( wbg_fs()->is_plan__premium_only('pro') ) {
			...
			// Reading Age
			$readingAge = array(
				'name' 				=> _x('Reading Age', WBG_TXT_DOMAIN),
				'singular_name' 	=> _x('Reading Age', WBG_TXT_DOMAIN),
				'search_items' 		=> __('Search Reading Age', WBG_TXT_DOMAIN),
				'all_items' 		=> __('All Reading Age', WBG_TXT_DOMAIN),
				'parent_item' 		=> __('Parent Reading Age', WBG_TXT_DOMAIN),
				'parent_item_colon'	=> __('Parent Reading Age:', WBG_TXT_DOMAIN),
				'edit_item' 		=> __('Edit Reading Age', WBG_TXT_DOMAIN),
				'update_item' 		=> __('Update Reading Age', WBG_TXT_DOMAIN),
				'add_new_item' 		=> __('Add New Reading Age', WBG_TXT_DOMAIN),
				'new_item_name' 	=> __('New Reading Age', WBG_TXT_DOMAIN),
				'menu_name' 		=> __('Reading Age', WBG_TXT_DOMAIN),
			);

			register_taxonomy('reading_age', array('books'), array(
				'hierarchical' 		=> true,
				'labels' 			=> $readingAge,
				'show_ui' 			=> true,
				'show_admin_column' => true,
				'query_var' 		=> true,
				'show_in_menu'		=> true,
				'rewrite' 			=> array('slug' => 'reading-age'),
			));

			// Grade level
			$grade_level = array(
				'name' 				=> _x('Grade Level', WBG_TXT_DOMAIN),
				'singular_name' 	=> _x('Grade Level', WBG_TXT_DOMAIN),
				'search_items' 		=> __('Search Grade Level', WBG_TXT_DOMAIN),
				'all_items' 		=> __('All Grade Level', WBG_TXT_DOMAIN),
				'parent_item' 		=> __('Parent Grade Level', WBG_TXT_DOMAIN),
				'parent_item_colon'	=> __('Parent Grade Level:', WBG_TXT_DOMAIN),
				'edit_item' 		=> __('Edit Grade Level', WBG_TXT_DOMAIN),
				'update_item' 		=> __('Update Grade Level', WBG_TXT_DOMAIN),
				'add_new_item' 		=> __('Add New Grade Level', WBG_TXT_DOMAIN),
				'new_item_name' 	=> __('New Grade Level', WBG_TXT_DOMAIN),
				'menu_name' 		=> __('Grade Level', WBG_TXT_DOMAIN),
			);

			register_taxonomy('grade_level', array('books'), array(
				'hierarchical' 		=> true,
				'labels' 			=> $grade_level,
				'show_ui' 			=> true,
				'show_admin_column' => true,
	...
	function wbg_book_details_metaboxes() {
		...
		if ( wbg_fs()->is_plan__premium_only('pro') ) {
			...
			add_meta_box(
				'wbgp-book-image-url',
				__('Book External Image Url', WBG_TXT_DOMAIN),
				array($this, 'wbgp_image_url_content'),
				'books',
				'normal',
				'high'
			);
